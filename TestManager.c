...
#include <stdio.h>
#include "BFS.h"                    //includes the heuristic

main()
{
    int resultBFS;                  //stores the result of the constructive heuristic
    int i = 0;

    double timeBFS;                 //stores the time of the constructive heuristic
    double resultBFSAccumulated = 0;
    ...
    printf("/********************************************************************\n");
    printf("* BREADTH FIRST SEARCH FOR THE MINIMIZATION OF OPEN STACKS PROBLEM  *\n");
    printf("/********************************************************************\n");
    printf("* AUTHORS: MARCO ANTONIO MOREIRA DE CARVALHO (marco.opt@gmail.com)\n");
    printf("* AND NEI YOSHIHIRO SOMA (soma@ita.br)\n");
    printf("* AERONAUTICS TECHNOLOGICAL INSTITUTE - BRAZIL\n");
    printf("* DATE OF CREATION: 27/04/2009\n");
    printf("* LAST MODIFICATION: 02/06/2009\n");
    printf("/********************************************************************\n");
    printf("* TERMS OF USE\n");
    printf("*\n");
    ...
    while (fscanf(fpIndex, "%s", inputFileName) != -1) {
        ...
        mainMethod(&resultBFS, &timeBFS, inputFileName);
        fprintf(fpOut, "%s %d %.10f\n", inputFileName, resultBFS, timeBFS);
        resultBFSAccumulated += resultBFS;
    }
